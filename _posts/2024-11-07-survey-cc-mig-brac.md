...
<script>
(function() {
  const FILE_URL = '/assets/files/survey_cc_mig_brac.xlsx';
...
<div style="margin-top: 1rem;">
  <iframe 
    src="https://ee.kobotoolbox.org/x/SutY2HFv"
    width="100%" 
    height="800px"
...
<p style="font-size:0.85rem; color:#888; margin-top:0.5rem;">
  ...
  <a href="https://ee.kobotoolbox.org/x/SutY2HFv" target="_blank">click here to open it directly</a>.
</p>
